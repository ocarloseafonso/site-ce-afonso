...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (whatsappFloat) {
    ...
    switch(pageType) {
      case 'home':
        message = 'Olá! Gostaria de agendar um horário no Ateliê DK.';
        break;
      case 'sobre':
        message = 'Olá! Gostaria de conhecer mais sobre o Ateliê DK.';
        break;
      case 'servicos':
        message = 'Olá! Gostaria de saber mais sobre os serviços do Ateliê DK.';
        break;
      case 'blog':
        message = 'Olá! Vi o blog do Ateliê DK e gostaria de agendar um horário.';
        break;
      case 'faq':
        message = 'Olá! Tenho uma dúvida e gostaria de mais informações.';
        break;
      case 'contato':
        message = 'Olá! Gostaria de mais informações sobre o Ateliê DK.';
        break;
      default:
        message = 'Olá! Gostaria de agendar um horário no Ateliê DK.';
    }
    ...
    whatsappFloat.setAttribute('href', 'https://wa.me/5524998221384?text=' + encodedMessage);
